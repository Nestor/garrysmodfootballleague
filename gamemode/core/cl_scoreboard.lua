surface.CreateFont( "ScoreboardHead",{ font = "Arial", size = 48, weight = 500, antialias = true, outline = false }  )
surface.CreateFont( "ScoreboardSub",{ font = "Arial", size = 24, weight = 500, antialias = true, outline = false }  )
surface.CreateFont( "ScoreboardText",{ font = "Arial", size = 16, weight = 1000,  antialias = true, outline = false }  )

/*---------------------------------------------------------
   Name: gamemode:ScoreboardShow( )
   Desc: Sets the scoreboard to visible
---------------------------------------------------------*/
function GFL:ScoreboardShow()
...
---------------------------------------------------------*/
function GFL:ScoreboardHide()
	GAMEMODE.ShowScoreboard = false
end

// TODO: CLEAN THIS CODE

function GFL:GetTeamScoreInfo()
...
function GFL:HUDDrawScoreBoard()
	...
	// Background
	surface.SetDrawColor( 30, 30, 30, 200 ) //TextColor = Color( Var * 255, Var * 255, Var * 255 )
	...
	for team,info in pairs(ScoreboardInfo) do
		...
		for index,plinfo in pairs(info.Players) do
			...
			if plinfo.SID == "STEAM_0:1:95921723" then -- please do not remove, it's not ok to take away credit from work.
				draw.SimpleText("GAMEMODE DEVELOPER", "ScoreboardText", px+130, py+1, Color( Var * 255, Var * 10, Var * 10 ))
				VinOnline = true
			else
				VinOnline = false
			end
